...
const Signup = () => {
  ...
  return (
    <div className='signup'>
            <h1 className="signuptitle" style={{marginBottom:"50px",textDecoration:"underline"}}>QR Code Generator for Emergency Contact <i class="fa-solid fa-qrcode" style={{marginLeft:"10px"}}></i></h1>
